...
# Sass Files
stylesheet '../../bower_components/foundation/scss/normalize.scss',                   :to => '_normalize.scss'
stylesheet '../../bower_components/foundation/scss/foundation/_settings.scss',       :to => '_settings.scss'
...
javascripts = copy_js_from("../../bower_components/foundation/js", "foundation", ["foundation.js", "index.js"])
vendor_javascripts = copy_js_from("../../bower_components/foundation/js", "vendor")

javascript "../../bower_components/foundation/js/foundation/foundation.js", :to => "foundation/foundation.js"
